---
title: "Extraction de secrets des navigateurs basés sur Chromium avec la DPAPI."
description: "Dans cet article nous voyons comment les secrets des navigateurs basés sur Chromium sur les systèmes Windows peuvent être extraits et déchiffrés en utilisant la DPAPI."
...
<div align=center>
	<h1>La Data Protection API et les navigateurs Chromium</h1>
</div>
